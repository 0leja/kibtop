        ...
        <>
            <div style={{background}} className={'event' + (isDark ? '' : ' event--light')}>
                ...
                <article className="event__article">
                    <h4 className="title mb-15 event__title">{title}</h4>
                    <p className="text mb-30">{desc}</p>
                    {
                        !!title &&
                            <Link href='/' className="more-link-text event__link">
                                <Text content="MORE" />
                                <svg className="more-icon" width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
